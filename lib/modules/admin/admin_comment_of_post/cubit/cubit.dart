...
class AdminCommentOfPostCubit extends Cubit<AdminCommentOfPostStates> {
  AdminCommentOfPostCubit() : super(AdminCommentOfPostInitialState());

  static AdminCommentOfPostCubit get(context) => BlocProvider.of(context);
